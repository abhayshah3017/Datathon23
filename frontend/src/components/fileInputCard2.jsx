...
const FileInputCard2 = ({ binderFile, setBinderFile }) => {
    ...
    const [isBinderHovered, setIsBinderHovered] = useState(false);
    ...
    const handleFileChange = (event) => {
        ...
        switch (selectedFile.type) {
            case 'application/pdf':
                ...
                break;
            default:
                toast.warn("Invalid file type. Please select a .pdf file.", {
                    position: "top-center",
                    autoClose: 5000,
    ...
    const handleBinderHover = () => {
        setIsBinderHovered(true);
    }

    const handleBinderHoverLeave = () => {
        setIsBinderHovered(false);
    }
    ...
    return (
        <div className="flex flex-col mx-auto my-8 ml-5 items-center">
            <div className="bg-white rounded-lg overflow-hidden shadow-md" style={{ width: '166px', height: '200px' }}>
                <div className="px-4">
                    {!binderFile && <label className=" text-blue-700 align-middle text-sm cursor-pointer">
                        <input
                            type="file"
                            accept=".pdf" // You can specify the allowed file types here
                            className="hidden"
            ...
            {binderFile && <div className='pt-2'>Binder</div>}
