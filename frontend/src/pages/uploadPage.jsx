    ...
    <div>
      {!loader && <div id='#body' className='text-center items-center'>
        <div className='font-bold text-4xl' style={{
          ...
          Annotate Deliverable document with Binder
        </div>
        <div className='text-lg text-gray-800' style={{ marginTop: '15px' }}>
          Convert your Deliverable document and Binder to Annotated document
        </div>
